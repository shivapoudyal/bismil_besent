		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-md-12">
					<div class="caption"><?php echo strtoupper($data['service_name'])?></div>
					<ol class="breadcrumb">
						...
						<div class="row">
								...
								<!------------------------------------------------ Header Part ------------------------------------------------> 
                                                    ...
                                                    <div class="col-sm-6 col-md-6">
                                                        ...
                                                        <br>
                                                        <div class="box">
                                                            <img src="<?php echo base_url(image_upload_path.$data['service_image'])?>" alt="" class="img-responsive" style="height:280px; width: 100%" />
							</div>
...
<!--							<div class="col-sm-6 col-md-6">
							...
							<div class="col-sm-12 col-md-12">
								<div class="description">
									<h5 class="blok-title">
										<?php echo strtoupper($data['service_name'])?>
									</h5>
