								...
								<div class="form-body">
									<?php echo form_open(base_url('Admin/saveService'), array('id' => 'saveService', 'data-toggle' => 'validator', 'role' => 'form', "enctype" => "multipart/form-data",)); ?>
                                                                    ...
                                                                    <input type="hidden" name="service_type" value="parent_service">
                                                                                ...
                                                                                <div class="form-group"> 
                                                                                    <label for="field-1">Service Name <b style="color:red">*</b></label> 
                                                                                        <input type="text" name="service_name" value="<?php echo $data["service_name"];?>" class="form-control" id="service_name" placeholder="Enter Service Name" required=""> 
										</div>
											...
											<label for="field-1-2">Uploaded Image </label> 
                                                                                        <img class="list-icon img-thumbnail" src="<?php echo base_url(image_upload_path.$data['service_image'])?>" style="width:60px; height: 50px" >
										</div> 
                                                                                </center>
