				...
				<div class="agile-tables">
					<div class="w3l-table-info">
						...
						<tbody>
							...
							<td><?php echo ucwords($data["blog_heading"]) ?></td>
                                                        <td>
                                                            <img class="list-icon img-thumbnail" src="<?php echo base_url(blog_image_upload_path.$blog_image)?>" style="width:60px; height: 50px" >
                                                        </td>
							<td><?php echo $status_array[$data["status"]] ?></td>
							<td><?php echo $data["created_at"]; ?></td>
                                                        <td>
                                                            <a href="<?php echo base_url('Admin/editBlog/'.$id); ?>"><button class="btn btn-xs btn-primary">Edit</button></a>
