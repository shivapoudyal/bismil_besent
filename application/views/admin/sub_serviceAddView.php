								...
								<div class="form-body">
									<?php echo form_open(base_url('Admin/saveService'), array('id' => 'saveService', 'data-toggle' => 'validator', 'role' => 'form', "enctype" => "multipart/form-data",)); ?>
                                                                            ...
                                                                            <input type="hidden" name="service_type" value="child_service">
                                                                                ...
                                                                                <div class="form-group"> 
                                                                                    <label for="field-1">Sub Service Name <b style="color:red">*</b></label> 
                                                                                        <input type="text" name="sub_service_name" class="form-control" id="service_name" placeholder="Enter Sub Service Name" required=""> 
										</div> 
										...
										<div class="form-group"> 
											<label for="field-1-2">Service Image <b style="color:red">*</b></label> 
											...
											<label for="field-1-3">About</label> 
                                                                                ...
                                                                                <div class="form-group"> 
											<label for="field-1-2">Services</label> 
                                                                                        <textarea name="service_tab" id="service_tab" required=""></textarea>
										</div> 
                                                                                                                                                        
                                                                                <div class="form-group"> 
											<label for="field-1-4">Offers</label> 
                                                                                        <textarea name="offer_tab" id="offer_tab" required=""></textarea>
										</div>
                                                                            
                                                                                <div class="form-group"> 
											<label for="field-1-5">Why Us</label> 
                                                                                        <textarea name="whyus_tab" id="whyus_tab" required=""></textarea>
										</div>
                                                                            
                                                                                <div class="form-group"> 
											<label for="field-1-5">Faqs</label> 
                                                                                        <textarea name="faqs_tab" id="faqs_tab" required=""></textarea>
										</div>
                                                                            
                                                                                <div class="form-group"> 
                                                                                    <label for="field-1">MRP <b style="color:red">*</b></label> 
                                                                                        <input type="text" name="mrp_price" class="form-control" id="mrp_price" placeholder="Enter MRP" required=""> 
										</div> 
                                                                            
                                                                                <div class="form-group"> 
                                                                                    <label for="field-1">Online Price <b style="color:red">*</b></label> 
                                                                                        <input type="text" name="online_price" class="form-control" id="online_price" placeholder="Enter Online Price" required=""> 
										</div>
