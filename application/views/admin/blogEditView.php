								...
								<div class="form-body">
									<?php echo form_open(base_url('Admin/saveBlog'), array('id' => 'saveBlog', 'data-toggle' => 'validator', 'role' => 'form', "enctype" => "multipart/form-data",)); ?>
                                                                    ...
                                                                    <input type="hidden" name="id" value="<?php echo $data["id"];?>">
                                                                                ...
                                                                                <div class="form-group"> 
                                                                                    <label for="field-1">Blog Heading Name <b style="color:red">*</b></label> 
                                                                                        <input type="text" name="blog_heading" value="<?php echo $data["blog_heading"];?>" class="form-control" id="blog_heading" placeholder="Enter Blog Heading" required=""> 
										</div>
											...
											<label for="field-1-2">Uploaded Image </label> 
                                                                                        <img class="list-icon img-thumbnail" src="<?php echo base_url(blog_image_upload_path.$data['blog_image'])?>" style="width:60px; height: 50px" >
										</div> 
                                                                            </center>
                                                                            										
										<div class="form-group"> 
											<label for="field-1-2">Blog Image </label> 
